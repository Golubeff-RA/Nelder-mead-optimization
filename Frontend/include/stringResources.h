...
namespace stringRes {
extern const char read_function_string[];
extern const char invalid_input_string[];
extern const char measure_string[];
extern const char input_function_string[];
extern const char read_button_string[];
extern const char clear_button_string[];
extern const char input_window_string[];
